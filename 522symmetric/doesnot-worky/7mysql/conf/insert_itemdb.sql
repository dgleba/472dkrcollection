...
values('all0',     '*' ,                 'main0',     current_timestamp,  current_timestamp,                     );
...
values('all0',     'corp_2_store',    100,                current_timestamp, current_timestamp);

-- insert into sym_trigger_router 
--       (trigger_id, router_id,        initial_load_order, last_update_time,  create_time)
-- values('all0',     'store_to_corp',  100,                current_timestamp, current_timestamp);
