...
These have already been run against this project..
  ...
  # This can work with sqlite in development. See production below for use with mysql.
    ...
    docker-compose run --rm djdev python manage.py createsuperuser --noinput --username hh --email=h@a.com 

    docker-compose run --rm djdev python  createsu.py
    
    docker-compose run --rm djdev python  manage.py shell
